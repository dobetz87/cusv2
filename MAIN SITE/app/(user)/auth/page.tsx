        ...
        {step === "phone" ? (
          <>
            ...
            <div className="mt-6 flex items-center justify-center gap-3">
              ...
              <span className="text-xs font-semibold text-[var(--text-muted)] uppercase tracking-wider">Atau</span>
              <div className="flex-1 h-px bg-[var(--border)]"></div>
            </div>
            ...
            <button
              ...
              className="mt-6 w-full flex items-center justify-center gap-3 py-4 rounded-[14px] bg-white border-2 border-[var(--border)] 
                         text-[var(--text-primary)] font-bold text-base hover:bg-gray-50 active:scale-[0.98] transition-all
